...
const T = {
  en: {
    ...
    featuredSub: "Handpicked for effective learning",
    typographyLabel: "Typography",
    playbackRate: "Speed",
    backgroundOverlay: "Background Overlay",
    barrierDesc: "Create a free account to unlock AI analysis, vocabulary building, and shadowing practice.",
    barrierRegister: "Register & Get 100 Free Credits",
    barrierSignIn: "Already have an account? Sign In",
  },
  zh: {
    appName: "TEDMaster",
    ...
    featuredSub: "优中选优，高效学习",
    typographyLabel: "排版设置",
    playbackRate: "播放速度",
    backgroundOverlay: "字幕背景",
    barrierDesc: "注册免费账号，解锁 AI 解析、生词本与跟读练习。",
    barrierRegister: "注册并获得 100 积分",
    barrierSignIn: "已有账号？点此登录",
  },
  "zh-tw": {
    appName: "TEDMaster",
    ...
    featuredTitle: "精選演講",
    featuredLoading: "載入中...",
    featuredSub: "優中選優，高效學習",
    typographyLabel: "排版設置",
    playbackRate: "播放速度",
    backgroundOverlay: "字幕背景",
    barrierDesc: "免費註冊，解鎖 AI 解析、單字本與跟讀練習。",
    barrierRegister: "註冊並獲得 100 積分",
    barrierSignIn: "已有帳號？點此登入",
  },
  ja: {
    appName: "TEDMaster",
    ...
    featuredSub: "厳選された効果的な学習コンテンツ",
    typographyLabel: "タイポグラフィ",
    playbackRate: "再生速度",
    backgroundOverlay: "字幕背景",
    barrierDesc: "無料登録でAI分析・単語帳・シャドーイングを解放。",
    barrierRegister: "登録して100ポイントをもらう",
    barrierSignIn: "アカウントをお持ちの方はこちら",
  },
} as const;
